...
| O11e | Capital falls before economy (NEW) | invader on capital the turn MOVE_CAPITAL is ordered | capture step voids the intent: no viceroy, town lost |
...
| B6 | Timeout kills | bot overruns its budget (1s main time, then 100ms byo-yomi cap +10ms/turn) | process killed, no orders this turn, **and all future turns** (dead) |
