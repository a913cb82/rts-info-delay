...
These six ideas cut think cost or spend the bank deliberately. Status: all
proposed, none implemented.

## 1. Incremental BotState
...
## 2. Anytime decide with staged prefixes
