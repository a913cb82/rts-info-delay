...
- opt17: parallel bot queries via select mux — pool fan-out tried (6.5x/round-trip regression, reverted); mux KEPT (fast game 7.6→3.8s paired, burst 215→72ms/turn) + fixed broken turn timeout (was 5018ms, now 101ms)
